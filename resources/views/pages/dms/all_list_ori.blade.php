      ...
      <table class="table-striped fontsizetable text-center" id="inbound_id"  width="100%" cellspacing="0">
        ...
        <tbody class="paddingtable text-center" id="tbody_inbound">
          ...
          <tr>   
            ...
            <td class="statusCell">
              <?php if ($inbound->status == '4') {
                echo "Start Unloading";
              } elseif ($inbound->status == '5') {
                echo "Complete Unloading";
              } else {
        ...
        $.ajax({
            ...
            success:function(msg){ 
                ...
                {  
                  ...
                  $("#tbody_inbound").append("<td>"+msg[0].inbound[i].vehicle_name+"</td>");
                  ...
                  $('#tbody_inbound tr').each(function() { 
                      ...
                      { 
                        ...
                        if(typeof arrival == 'undefined' || arrival == null || arrival == '')
		              	{
		          	  	...
		          	  	else
		          	  	{
			              	...
			              	var dr=ar[0].split("-");
			              	var tr=ar[1].split(":");
			              	var HourAdd1 = new Date(dr[1]+'/'+dr[2]+'/'+dr[0]+' '+ar[1]).getTime()+(1000*60*10);
			            }
                        ...
                        if(typeof ls3 == 'undefined' || ls3 == null || ls3 == '')
		              	{
		          	  	...
		          	  	else
		          	  	{
			              	...
			              	var d3=a3[0].split("-");
			              	var t3=a3[1].split(":");
			              	var hourStat4 = new Date(d3[1]+'/'+d3[2]+'/'+d3[0]+' '+a3[1]).getTime()+(1000*60*10);
			            }
                        ...
                        if(typeof ls5 == 'undefined' || ls5 == null || ls5 == '')
		              	{
		          	  	...
		          	  	else
		          	  	{
			              	...
			              	var d5=a5[0].split("-");
			              	var t5=a5[1].split(":");
			              	var Minute15Stat6 = new Date(d5[1]+'/'+d5[2]+'/'+d5[0]+' '+a5[1]).getTime()+(1000*60*10);
			            }
                        ...
                        else if (statusid == '5') {var cetakstatus = 'Complete Unloading'}
	              ...
	              if(typeof i_duration != 'undefined')
	              {
	              ...
	              if(typeof i_exitTime != 'undefined')
	              {
                ...
                for(i=0;i<count_outbound;i++)
                {
                  ...
                  $("#tbody_outbound").append("<td>"+msg[0].outbound[i].vehicle_name+"</td>");
                  ...
                  $('#tbody_outbound tr').each(function() { 
                      ...
                      { 
                        ...
                        $(this).find("td.driverCell").html(msg[0].outbound[i].driver_name);
                        $(this).find("td.transporterCell").html(msg[0].outbound[i].transporter_company);
                        //Waiting Outside
	              ...
	              if(typeof o_duration != 'undefined')
	              {
	              ...
	              if(typeof o_exitTime != 'undefined')
	              {
